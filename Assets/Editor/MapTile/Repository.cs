...
namespace WolfConverter
{
    namespace MapTile
    {
        class Repository
        {
            ...
            {
                Util.Wolf.WolfDataReader reader = new Util.Wolf.WolfDataReader(dataPath);
            ...
            private UnitTile ReadUnitTile(Util.Wolf.WolfDataReader reader, int tagNumber, int offset, out int nextOffset)
            {
